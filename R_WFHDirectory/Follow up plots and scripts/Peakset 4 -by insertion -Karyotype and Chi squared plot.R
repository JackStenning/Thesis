...
tiff("Lowstringency_Chisquared_insertions.tiff", width = 3510, height = 2481, res = 300)
...
tag <- "Lowstringency_insertions_Chisquared"  # replace with a unique label for each script
