...
bedGraphToBigWig ENCFF063JMY_sorted.bedgraph /mnt/scratch/users/jps558/staging/hg38/hg38.chrom.sizes ENCFF063JMY.bw
...
python -m venv CallingCardsPython

source CallingCardsPython/bin/activate
...
fig.savefig('custom_signal_plot.png', dpi=300, bbox_inches='tight')
