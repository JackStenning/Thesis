...
for filt in filtered_slop*.bed; do
	...
	#Count the lines
	wc -l andy/"$filt"_true_positive_andy.bed > andy/count_"$filt"_true_positive_andy.bed
	wc -l encode/"$filt"_true_positive_encode.bed > encode/count_"$filt"_true_positive_encode.bed
	...
	#Count the lines
	wc -l andy/"$filt"_false_positive_andy_.bed > andy/count_"$filt"_false_positive_andy_.bed
	wc -l encode/"$filt"_false_positive_encode_.bed > encode/count_"$filt"_false_positive_encode_.bed
	...
	#Count the lines
	wc -l andy/"$filt"_false_negative_andy_.bed > andy/count_"$filt"_false_negative_andy_.bed
	wc -l encode/"$filt"_false_negative_encode_.bed > encode/count_"$filt"_false_negative_encode_.bed
	...
	#Count the lines
	wc -l andy/"$filt"_true_negative_andy.bed > andy/count_"$filt"_true_negative_andy.bed
	wc -l encode/"$filt"_true_negative_encode.bed > encode/count_"$filt"_true_negative_encode.bed
done
