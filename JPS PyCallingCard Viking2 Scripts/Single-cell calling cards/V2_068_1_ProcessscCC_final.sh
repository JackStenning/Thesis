...
# Run on scCC trimmed samples with barcode
...
nextflow run epi2me-labs/wf-single-cell \
  ...
  --matrix_min_cells 1 \
  --matrix_max_mito 50 \
  --out_dir 'result_pretrimmed_50Mit'
...
#Below gave same result as above
...
#  --matrix_min_cells 1 \
#  --matrix_max_mito 80 \
#  --out_dir 'result_pretrimmed_80Mit'
...
#  --matrix_min_cells 1 \
#  --matrix_max_mito 90 \
#  --out_dir 'result_pretrimmed_90Mit'
