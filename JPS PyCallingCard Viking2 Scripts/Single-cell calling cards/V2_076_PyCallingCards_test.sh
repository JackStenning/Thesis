...
import os
os.chdir('/mnt/scratch/users/jps558/Stenning_Data_Analysis/2024-JS-ssCC/CallingCards_ONT/Results/E1_barcodeFollowUpTest/result_full')

## Full results
ER = cc.rd.read_qbed("JS_ES1_allpass_adapter_trimmed.tagged.bam_final.sorted.ccf")
ER
...
peak_data_ER_WT2 = cc.pp.call_peaks(ER, method = "MACCs", reference = "hg38", pvalue_cutoffbg = 0.001,
                             ...
                             lam_win_size = 1000000, pseudocounts = 10, record = True, save = "./peak_data_ER_test2.bed")
peak_data_ER_WT2
...
peak_data_ER_WT4 = cc.pp.call_peaks(ER, method = "MACCs", reference = "hg38", pvalue_cutoffbg = 0.01,
                             ...
                             lam_win_size = 1000000, pseudocounts = 10, record = True, save = "./peak_data_ER_test4.bed")
...
signalmtx = cc.pl.calculate_signal(ER, '/mnt/scratch/users/jps558/Stenning_Data_Analysis/Final_year/SRR6652020_A90.bw')
